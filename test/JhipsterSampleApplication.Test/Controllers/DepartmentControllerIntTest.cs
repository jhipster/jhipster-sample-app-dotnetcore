...
namespace JhipsterSampleApplication.Test.Controllers
{
    public class DepartmentsControllerIntTest
    {
        ...
        private const string DefaultDepartmentName = "546c776b3e23f5f2ebdd3b03";
        private const string UpdatedDepartmentName = "546c776b3e23f5f2ebdd3b0a";
        ...
        public async Task CheckDepartmentNameIsRequired()
        {
            ...
            _department.DepartmentName = default;
