...
describe('TimeSheet Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'dec9d8a0-409c-4f6d-b493-f7f154c53ff6' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'd6f552c0-8ee7-4bb7-8593-218d779b5369' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.timeSheets()[0]).toEqual(expect.objectContaining({ id: 'dec9d8a0-409c-4f6d-b493-f7f154c53ff6' }));
  });
