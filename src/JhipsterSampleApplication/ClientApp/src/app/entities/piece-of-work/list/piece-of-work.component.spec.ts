...
import { sampleWithRequiredData } from '../piece-of-work.test-samples';
...
describe('PieceOfWork Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pieceOfWorks()[0]).toEqual(expect.objectContaining({ id: 32037 }));
  });
