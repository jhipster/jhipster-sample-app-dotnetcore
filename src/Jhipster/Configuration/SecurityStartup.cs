...
using AuthenticationService = MyCompany.Domain.Services.AuthenticationService;
using IAuthenticationService = MyCompany.Domain.Services.Interfaces.IAuthenticationService;
